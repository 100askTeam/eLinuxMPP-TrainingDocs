...
const config = {
  title: '东山PI',
  tagline: 'DshanPI Embedded Video Audio Dev.',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://eav.100ask.net',
  ...
  projectName: 'eLinuxMPP-TrainingDocs', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/100askTeam/eLinuxMPP-TrainingDocs/tree/main/',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/100askTeam/eLinuxMPP-TrainingDocs',
            label: 'GitHub',
            position: 'right',
          },
        ],
